		...
		<div class="swift-performance-header">
                  ...
                  <div data-animation-in="fadeIn">
                        ...
                        <ul class="swift-preset-list">
                              ...
                              <li class="swift-preset-list-item">
                                    ...
                                    <div class="swift-buttonset swift-pull-right">
                                          <?php esc_html_e('This preset is available in Pro only.', 'swift-performance');?>
                                    </div>
                              </li>
                              <li class="swift-preset-list-item">
                                    <div class="swift-preset-title">
            ...
            <div class="swift-setup-slide has-bg" id="finish">
				...
				<h3><?php esc_html_e('Your website is ready!', 'swift-performance'); ?></h3>
                        <p>
                        	<em><?php _e('You can check advanced settings also to improve your results.<br> If you need any help, check the <a href="https://swiftperformance.io/faq/" target="_blank">FAQ</a>, <a href="https://swiftperformance.io/documentation/" target="_blank">Knowledge Base</a>, or join to the <a href="https://www.facebook.com/groups/SwiftPerformanceUsers/" target="_blank">Facebook Community!</a>', 'swift-performance');?></em>
                        </p>
                        <p>
